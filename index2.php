...
<!--   <link href="style2.css" rel="stylesheet" type="text/css" /> -->
    <link href="../zfound5/css/foundation.css" rel="stylesheet" type="text/css" />            
   <script src="../zfound5/js/vendor/modernizr.js"></script> 
  </head>   
        <script src="../zfound5/js/vendor/jquery.js"></script>
        <script src="../zfound5/js/vendor/fastclick.js"></script>
		<script type="text/javascript" src="../zfound5/js/foundation.min.js"></script>  
        <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false"></script> 
    	<script type="text/javascript" src="map2.js"></script>


<body onload="toggleLayer(2); toggle_visibility('dtlivelegend')">
